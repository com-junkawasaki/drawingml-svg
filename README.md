...
- SVG: `rect`, `circle`, `ellipse`, `line`, `polygon`, `polyline`, linear/quadratic/cubic/arc `path`, simple rect/text and line/text grids including merged cells as native DrawingML tables, `text`, simple `tspan`, link/group containers, and basic `switch` fallback selection
