...
- Paint: solid fill, stroke color, stroke width, line cap/join/miter/custom dash, fill/stroke alpha, short/long alpha hex colors, CSS rgb/hsl color functions, named colors, gradient fallback
